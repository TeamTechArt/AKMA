...
|:-------------:|:-------------:|:-------------:|:-------------:|
| [최동현](https://github.com/donghyundavidchoi) | Project Manager | david0302@naver.com | Project Management, Model Framework Development, ML Research, Model Optimization, Data Acquisition |
| [이상현](https://github.com/oddhyeon) | Technology Manager | roughideal@gmail.com | Model Management, StyleGAN3 Training, Server Engineering, ML Research,  Model Automation |
...
| [이호진](https://github.com/ghwlsdl) | Team Member | hojinlee93@gmail.com | Model QA, Model Experiment, Model Optimization, ML Research, Documentation | 
...
![Audio Kinetic Media Art](https://user-images.githubusercontent.com/89892032/191466666-8dfc32c3-39d2-4306-82da-ac95e8401e71.png)
...
## Sample-Result
 - [AKMA+awesome_landscape+Real-ESRGAN+PARADOX](https://youtu.be/tZN3QWIbHN4)
 - [AKMA+awesome_wikiart+PARADOX](https://youtu.be/6ZiN-S_SdgI)
 - [AKMA+EAST-SEA](https://youtu.be/KyupK_utxYc)
